...
export const Contact: React.FC = () => {
  return (
    ...
    >
      <div className="w-10/12 mx-auto bg-background p-4 lg:p-8 rounded-xl flex flex-col lg:flex-row items-stretch space-y-8 lg:space-y-0 relative z-10 shadow-md border border-accent shadow-gray-500/50">
